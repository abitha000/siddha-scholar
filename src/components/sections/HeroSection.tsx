  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden leaf-pattern">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          className="absolute bottom-20 right-10 w-80 h-80 bg-[#d4a574]/5 rounded-full blur-3xl animate-pulse-soft"
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-0">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              Consult with Dr. Amirtha, a BSMS Gold Medalist &amp; certified
              Siddha physician, from the comfort of your home. Evidence-aware
              traditional care for lasting wellness.
            </motion.p>
            ...
            <div className="relative w-72 h-72 sm:w-96 sm:h-96 lg:w-[440px] lg:h-[440px]">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#5c6b5c]">
                    Siddha Doctor
                  </p>
                </div>
              </motion.div>
